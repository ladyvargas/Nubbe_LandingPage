<template>
  <section class="pt-120 pb-115 app-shot-one" id="app" style="background-color: beige;">
              <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-8">
                        <!-- section title -->
                        <div class="section-title text-center">
                            <h2>¿Comó tener nuestro servicio?</h2>
                            <p>Nuestra aplicación es muy facil de utilizar y comprender.</p>
                        </div>
                  ...
                  <div class="app-shot-one__carousel thm__owl-carousel">
                    ...
                    <swiper :options="swiperOptions">
                      ...
                      <!-- slingle app image -->
                      <div class="item">
                          <img src="/assets/img/feature/5.png" alt="">
                      </div>
                      <!-- slingle app image -->
                      </swiper-slide>
